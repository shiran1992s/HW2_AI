...
class Player(AbstractPlayer):
    ...
    def update_fruits(self, fruits_on_board_dict):
        ...
        No output is expected.
        """
        # DONE: erase the following line and implement this function. In case you choose not to use it, use 'pass' instead of the following line.
        pass
    ...
    # DONE: add here helper functions in class, if needed


# DONE: very basic need to consider fruits positions and values
 ...
 ########## helper functions for MiniMax algorithm ##########
    # DONE: add here the utility, succ, and perform_move functions used in MiniMax algorithm
